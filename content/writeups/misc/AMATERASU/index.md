...
![running an nmap scan on amaterasu machine](https://cdn.ziomsec.com/amaterasu/1.webp)
![running an nmap scan on amaterasu machine](https://cdn.ziomsec.com/amaterasu/2.webp)
![running an nmap scan on amaterasu machine](https://cdn.ziomsec.com/amaterasu/3.webp)
...
![accessing the web service](https://cdn.ziomsec.com/amaterasu/4.webp)
...
![running a fuzz scan on the target](https://cdn.ziomsec.com/amaterasu/5.webp)
...
![running directory bruteforcing](https://cdn.ziomsec.com/amaterasu/6.webp)

I accessed the discovered paths and found endpoints to perform various operations.

![accessing the discovered endpoint](https://cdn.ziomsec.com/amaterasu/7.webp)

![accessing the discovered endpoint](https://cdn.ziomsec.com/amaterasu/8.webp)

The `file-list?dir=/tmp` endpoint allowed me to view the contents of the **`/tmp`** directory.

![viewing contents of tmp directory](https://cdn.ziomsec.com/amaterasu/9.webp)
...
![creating a file](https://cdn.ziomsec.com/amaterasu/10.webp)
![uploading a file to the web app](https://cdn.ziomsec.com/amaterasu/11.webp)

I navigated to the `file-list` endpoint and found my uploaded file.

![viewing uploaded files on the web app](https://cdn.ziomsec.com/amaterasu/12.webp)
...
![viewing contents of the home directory](https://cdn.ziomsec.com/amaterasu/13.webp)

![viewing contents of the home directory](https://cdn.ziomsec.com/amaterasu/14.webp)

Inside **Alfred's** home directory, I found the **.ssh** folder so I looked into it. I also found the first flag here.

![exploring Alfred's directory](https://cdn.ziomsec.com/amaterasu/15.webp)
...
![creating an ssh key](https://cdn.ziomsec.com/amaterasu/16.webp)
...
![copying the public key into a text file](https://cdn.ziomsec.com/amaterasu/17.webp)
...
![uploading the public key to alfred's directory](https://cdn.ziomsec.com/amaterasu/18.webp)

![uploading the public key to alfred's directory](https://cdn.ziomsec.com/amaterasu/19.webp)
...
![logging in via ssh](https://cdn.ziomsec.com/amaterasu/20.webp)

Upon logging in, I captured the first flag from the home directory.

![capturing the first flag on amaterasu](https://cdn.ziomsec.com/amaterasu/21.webp)
...
![running linPEAS on the amaterasu machine](https://cdn.ziomsec.com/amaterasu/22.webp)
...
![viewing cronjobs](https://cdn.ziomsec.com/amaterasu/23.webp)
...
![checking the tmp directory](https://cdn.ziomsec.com/amaterasu/24.webp)
...
![crafting an exploit](https://cdn.ziomsec.com/amaterasu/25.webp)
...
![verifying the exploit worked](https://cdn.ziomsec.com/amaterasu/26.webp)
...
![capturing root flag](https://cdn.ziomsec.com/amaterasu/27.webp)
