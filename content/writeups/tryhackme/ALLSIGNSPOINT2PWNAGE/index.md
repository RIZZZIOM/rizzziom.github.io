...
![performing an nmap scan on allsigns2pwnage machine](https://cdn.ziomsec.com/allsignspoint2pwnage/1.webp)
![performing an nmap scan on allsigns2pwnage machine](https://cdn.ziomsec.com/allsignspoint2pwnage/2.webp)
...
![connecting to ftp and downloading the file](https://cdn.ziomsec.com/allsignspoint2pwnage/3.webp)

The text contained a notice regarding a file share on the target for image upload and management.

![reading the file](https://cdn.ziomsec.com/allsignspoint2pwnage/4.webp)
...
![listing smb shares on the target](https://cdn.ziomsec.com/allsignspoint2pwnage/5.webp)
...
![accessing smb share](https://cdn.ziomsec.com/allsignspoint2pwnage/6.webp)
...
![accessing the web aplication](https://cdn.ziomsec.com/allsignspoint2pwnage/7.webp)
...
![fuzzing hidden files on the web app](https://cdn.ziomsec.com/allsignspoint2pwnage/8.webp)
...
![fuzzing hidden directories](https://cdn.ziomsec.com/allsignspoint2pwnage/9.webp)
...
![uploading php reverse shell via smb share](https://cdn.ziomsec.com/allsignspoint2pwnage/10.webp)

refreshing the `images` webpage reflected the uploaded payload.

![accessing the images endpoint](https://cdn.ziomsec.com/allsignspoint2pwnage/11.webp)
...
![executing the payload](https://cdn.ziomsec.com/allsignspoint2pwnage/12.webp)
...
![uploading Ivan Sincek's php reverse shell payload](https://cdn.ziomsec.com/allsignspoint2pwnage/13.webp)

Finally, I executed the payload through the web application and got a reverse shell.

![getting a reverse shell](https://cdn.ziomsec.com/allsignspoint2pwnage/14.webp)
...
![capturing the user flag](https://cdn.ziomsec.com/allsignspoint2pwnage/15.webp)
...
![viewing shares](https://cdn.ziomsec.com/allsignspoint2pwnage/16.webp)

I visited the share and found some interesting files.

![listing shared folder contents](https://cdn.ziomsec.com/allsignspoint2pwnage/17.webp)

The `Install_www_and_deploy.bat` file seemed unusual so I read its contents and found *administrator*'s password.

![reading the batch file](https://cdn.ziomsec.com/allsignspoint2pwnage/18.webp)
...
![inspecting windows logon registry hive](https://cdn.ziomsec.com/allsignspoint2pwnage/19.webp)
...
![inspecting ultravnc config file](https://cdn.ziomsec.com/allsignspoint2pwnage/20.webp)
...
![decoding the cyphertext](https://cdn.ziomsec.com/allsignspoint2pwnage/21.webp)

While enumeration, I also found that I had `SeImpersonatePrivilege` enabled, I could use this to get **NT AUTHORTIY** access.

![listing user privileges](https://cdn.ziomsec.com/allsignspoint2pwnage/22.webp)
...
![executing printspoofer exploit](https://cdn.ziomsec.com/allsignspoint2pwnage/23.webp)
...
![capturing the root flag](https://cdn.ziomsec.com/allsignspoint2pwnage/24.webp)
