...
![performing an nmap scan on anthem machine](https://cdn.ziomsec.com/anthem/1.webp)

## Initial Foothold

The **nmap** scan revealed an **http** server running on the target. So I accessed it from my browser.

![accessing the web application](https://cdn.ziomsec.com/anthem/2.webp)
...
![fuzzing hidden files on the web app](https://cdn.ziomsec.com/anthem/3.webp)
...
![accessing the robots.txt file](https://cdn.ziomsec.com/anthem/4.webp)

I continued analyzing the application and found an email address.

![analyzing web application](https://cdn.ziomsec.com/anthem/5.webp)

![analyzing web application](https://cdn.ziomsec.com/anthem/6.webp)
...
![analyzing web application](https://cdn.ziomsec.com/anthem/7.webp)

![capturing the first flag](https://cdn.ziomsec.com/anthem/8.webp)

I reviewed the source code of my home page and found another flag.

![capturing the second flag](https://cdn.ziomsec.com/anthem/9.webp)
...
![accessing umbraco login panel](https://cdn.ziomsec.com/anthem/10.webp)
...
![accessing CMS login panel](https://cdn.ziomsec.com/anthem/11.webp)

I viewed the source code and got another flag.

![capturing the third flag](https://cdn.ziomsec.com/anthem/12.webp)

I viewed the source code of other pages from here and found another flag in `/archive/a-cheers-to-our-it-department/`

![capturing the fourth flag](https://cdn.ziomsec.com/anthem/13.webp)
...
![checking for rdp access](https://cdn.ziomsec.com/anthem/14.webp)
...
![capturing the user flag](https://cdn.ziomsec.com/anthem/15.webp)
...
![accessing the text file](https://cdn.ziomsec.com/anthem/16.webp)

Hence, I modified the file's properties to allow the machine account to read the file.

![modifying file properties](https://cdn.ziomsec.com/anthem/17.webp)

![modifying file properties](https://cdn.ziomsec.com/anthem/18.webp)

![modifying file properties](https://cdn.ziomsec.com/anthem/19.webp)

Finally I read the file and found a string. I was then able to log in as `Administrator` using this as a password.

![reading the text file](https://cdn.ziomsec.com/anthem/20.webp)

I then captured the final flag from desktop.

![capturing the root flag](https://cdn.ziomsec.com/anthem/21.webp)
