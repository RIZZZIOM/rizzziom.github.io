...
![performing an nmap aggressive scan on billing machine](https://cdn.ziomsec.com/billing/1.webp)

## Initial Access

The target had a web server running so I accessed the web page through my browser.

![accessing the web application running on the target](https://cdn.ziomsec.com/billing/2.webp)
...
![accessing robots.txt](https://cdn.ziomsec.com/billing/3.webp)
...
![searching for exploits for asterisk](https://cdn.ziomsec.com/billing/4.webp)
...
![running exploit on the target](https://cdn.ziomsec.com/billing/5.webp)
...
![spawning a shell](https://cdn.ziomsec.com/billing/6.webp)
...
![capturing the user flag](https://cdn.ziomsec.com/billing/7.webp)
...
![listing sudo privileges](https://cdn.ziomsec.com/billing/8.webp)
...
![running the allowed sudo command](https://cdn.ziomsec.com/billing/9.webp)
...
![looking for ways to exploit the allowed command](https://cdn.ziomsec.com/billing/10.webp)
...
![verifying exploit](https://cdn.ziomsec.com/billing/11.webp)
...
![capturing the root flag](https://cdn.ziomsec.com/billing/12.webp)
