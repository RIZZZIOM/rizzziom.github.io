...
![performing an nmap scan on gamezone machine](https://cdn.ziomsec.com/gamezone/1.webp)

## Foothold

I accessed the web application through my browser.

![accessing the web application](https://cdn.ziomsec.com/gamezone/2.webp)
...
![bypassing login with sqli](https://cdn.ziomsec.com/gamezone/3.webp)

This gave me access to a page with search functionality.

![page with search functionality](https://cdn.ziomsec.com/gamezone/4.webp)

I searched for something and captured the request on **Burp Suite**.

![inspecting the request on Burp Suite](https://cdn.ziomsec.com/gamezone/5.webp)
...
![testing for sqli](https://cdn.ziomsec.com/gamezone/6.webp)

I then saved the request to a file and used **sqlmap** to dump database information.

![saving the request for sqlmap](https://cdn.ziomsec.com/gamezone/7.webp)

```shell
sqlmap -r request.txt --dbs
```

![dumping database info](https://cdn.ziomsec.com/gamezone/8.webp)
...
![dumping db contents](https://cdn.ziomsec.com/gamezone/9.webp)

I found the password hash for the user **agent47**.

![password hash for agent47](https://cdn.ziomsec.com/gamezone/10.webp)

I then cracked the hash on **Crackstation**.

![cracking the password hash](https://cdn.ziomsec.com/gamezone/11.webp)
...
![cracking the password hash](https://cdn.ziomsec.com/gamezone/12.webp)
...
![accessing the target via SSH](https://cdn.ziomsec.com/gamezone/13.webp)

Finally, I captured the user flag from **agent47**'s home directory.

![capturing the user flag](https://cdn.ziomsec.com/gamezone/14.webp)
...
![listing connections and listening ports](https://cdn.ziomsec.com/gamezone/15.webp)
...
![scanning the internal service](https://cdn.ziomsec.com/gamezone/16.webp)
...
![acessing the local service via the browser](https://cdn.ziomsec.com/gamezone/17.webp)
...
![acessing the local service via the browser](https://cdn.ziomsec.com/gamezone/18.webp)

I tried logging in using the **ssh** credential of the user '**agent47**'.

![logging in as agent47](https://cdn.ziomsec.com/gamezone/19.webp)
...
![searching for exploits](https://cdn.ziomsec.com/gamezone/20.webp)
...
![inspecting the webmin service](https://cdn.ziomsec.com/gamezone/21.webp)
...
![configuring the payload on metasploit](https://cdn.ziomsec.com/gamezone/22.webp)
...
![ruunning the exploit for root access](https://cdn.ziomsec.com/gamezone/23.webp)
...
![capturing the root flag](https://cdn.ziomsec.com/gamezone/24.webp)
