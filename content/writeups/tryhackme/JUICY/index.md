...
![interacting with the chatbot](https://cdn.ziomsec.com/juicy/1.webp)
...
![trying to get information about the house and wifi](https://cdn.ziomsec.com/juicy/2.webp)
...
![making the bot reveal the system prompt](https://cdn.ziomsec.com/juicy/3.webp)
...
![making the bot reveal the prompt injection flag](https://cdn.ziomsec.com/juicy/4.webp)

I then viewed the page source and found a link to an interesting `json` file.

![inspecting the page source](https://cdn.ziomsec.com/juicy/5.webp)

When I accessed the `json` file, I found a secret endpoint : `/internal/secret`

![accessing the secret endpoint](https://cdn.ziomsec.com/juicy/6.webp)
...
![testing for html injection vulnerability](https://cdn.ziomsec.com/juicy/7.webp)
...
![exploiting cross site scripting](https://cdn.ziomsec.com/juicy/8.webp)

On my listener, I got a request with url + base64 encoded content of the internal endpoint.

![receiving a callback from the chatbot](https://cdn.ziomsec.com/juicy/9.webp)
...
![decoding the data to get the final flag](https://cdn.ziomsec.com/juicy/10.webp)
