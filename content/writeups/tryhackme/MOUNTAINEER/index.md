...
![performing an nmap scan on mountaineer machine](https://cdn.ziomsec.com/mountaineer/1.webp)

## Initial Foothold

I accessed the web application running on the target and landed on a default **nginx** page.

![accessing the web application](https://cdn.ziomsec.com/mountaineer/2.webp)
...
![fuzzing for hidden directories](https://cdn.ziomsec.com/mountaineer/3.webp)
...
![inspecting the requests made by the web app](https://cdn.ziomsec.com/mountaineer/4.webp)

I mapped the domain to the target IP in my */etc/hosts* file and refreshed the page.

![accessing the web application](https://cdn.ziomsec.com/mountaineer/5.webp)
...
![scanning the wordpress website](https://cdn.ziomsec.com/mountaineer/6.webp)

![scanning the wordpress website](https://cdn.ziomsec.com/mountaineer/7.webp)
...
![searching for auxiliary scanners](https://cdn.ziomsec.com/mountaineer/8.webp)
...
![running the scanner](https://cdn.ziomsec.com/mountaineer/9.webp)

However, these credentials did not work.

![testing the creds](https://cdn.ziomsec.com/mountaineer/10.webp)
...
![fuzzing more directories](https://cdn.ziomsec.com/mountaineer/11.webp)
...
![reading /etc/passwd file](https://cdn.ziomsec.com/mountaineer/12.webp)
...
![searching for config file](https://cdn.ziomsec.com/mountaineer/13.webp)
...
![fuzzing config file path](https://cdn.ziomsec.com/mountaineer/14.webp)
...
![reading the config file](https://cdn.ziomsec.com/mountaineer/15.webp)

I added the subdomain in my `/etc/hosts` file and accessed the endpoint.

![accessing the subdomain](https://cdn.ziomsec.com/mountaineer/16.webp)
...
![accessing the mail](https://cdn.ziomsec.com/mountaineer/17.webp)

Another mail was about the password that was revealed.

![accessing the mail](https://cdn.ziomsec.com/mountaineer/18.webp)

I tried the password with the `k2` user and managed to log in through the `wp-login` endpoint.

![logging into wordpress](https://cdn.ziomsec.com/mountaineer/19.webp)
...
![spawning shell as www-data](https://cdn.ziomsec.com/mountaineer/20.webp)
...
![enumeratin user contents](https://cdn.ziomsec.com/mountaineer/21.webp)

I found a file called *ToDo.txt* inside *nanga*'s home directory which contained an interesting message.

![reading the message](https://cdn.ziomsec.com/mountaineer/22.webp)

I also found a **keepass** file inside *lhotse*'s home directory.

![discovering a keepass file](https://cdn.ziomsec.com/mountaineer/23.webp)

I downloaded the file locally and tried opening it. However, it was password protected.

![attempting to open the keepass file](https://cdn.ziomsec.com/mountaineer/24.webp)
...
![reading mail](https://cdn.ziomsec.com/mountaineer/25.webp)

I found some interesting information that could be used to create a custom password list.

![reading mail](https://cdn.ziomsec.com/mountaineer/26.webp)
...
![generating custom wordlist](https://cdn.ziomsec.com/mountaineer/27.webp)

I then restarted password cracking with **john** using the custom wordlist and found the password.

![cracking kdbx file password](https://cdn.ziomsec.com/mountaineer/28.webp)

The password allowed me to view the contents inside the file where I found user credentials.

![discovering the usre credentials](https://cdn.ziomsec.com/mountaineer/29.webp)

Since, *kangchenjunga* had the local flag, I logged into the target using **ssh**.

```shell
ssh kangchenjunga@TARGET
```

Finally, I captured the local flag.

![capturing the local flag](https://cdn.ziomsec.com/mountaineer/30.webp)
...
![reading the bash history](https://cdn.ziomsec.com/mountaineer/31.webp)
...
![switching to root](https://cdn.ziomsec.com/mountaineer/32.webp)

![capturing the root flag](https://cdn.ziomsec.com/mountaineer/33.webp)
