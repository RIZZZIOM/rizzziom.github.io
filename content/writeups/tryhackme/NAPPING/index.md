...
![performing nmap scan on napping machine](https://cdn.ziomsec.com/napping/1.webp)

## Initial Foothold

I accessed the web application through my browser and found a login page.

![accessing the login panel](https://cdn.ziomsec.com/napping/2.webp)

Since I did not have the credentials to log in, I signed up from the Sign up page

![signing up on the application](https://cdn.ziomsec.com/napping/3.webp)
...
![fuzzing hidden directories](https://cdn.ziomsec.com/napping/4.webp)

```shell
ffuf -u http://TARGET/FUZZ -w /usr/share/wordlists/seclists/Discovery/Web-Content/raft-large-files.txt -fc 404
```

![fuzzing hidden files](https://cdn.ziomsec.com/napping/5.webp)
...
![logging into the application](https://cdn.ziomsec.com/napping/6.webp)

![testing for ssrf](https://cdn.ziomsec.com/napping/7.webp)
...
![finding a misconfig for tab nabbing](https://cdn.ziomsec.com/napping/8.webp)
...
![creating the bait](https://cdn.ziomsec.com/napping/9.webp)

I then copied the source code on `/admin/login.php` into `login.html`

![creating the phishing login page](https://cdn.ziomsec.com/napping/10.webp)
...
![hosting both the pages](https://cdn.ziomsec.com/napping/11.webp)

![inspecting traffic with wireshark](https://cdn.ziomsec.com/napping/12.webp)
...
![logging in as user](https://cdn.ziomsec.com/napping/13.webp)
...
![reading the python script](https://cdn.ziomsec.com/napping/14.webp)

I also found the sql credentials in `/var/www/html/config.php` but didn't find anything useful in the database.

![reading the web config file](https://cdn.ziomsec.com/napping/15.webp)

I then modified the `query.py` script to get a reverse shell on my netcat listener.

![modifying the python script for a reverse shell](https://cdn.ziomsec.com/napping/16.webp)

I started a netcat listener and got a reverse shell as *adrean*.

![getting a reverse shell](https://cdn.ziomsec.com/napping/17.webp)

Finally, I captured the user flag.

![capturing the user flag](https://cdn.ziomsec.com/napping/18.webp)
...
![listing sudo privs](https://cdn.ziomsec.com/napping/19.webp)
...
![capturing the root flag](https://cdn.ziomsec.com/napping/20.webp)
