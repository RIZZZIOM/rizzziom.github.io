...
![performing an nmap scan on skynet machine](https://cdn.ziomsec.com/skynet/1.webp)

## Foothold

I visited the web application running on the target through my browser.

![accessing the web application](https://cdn.ziomsec.com/skynet/2.webp)
...
![fuzzing for hidden directories](https://cdn.ziomsec.com/skynet/3.webp)

Visiting the endpoint revealed a login panel.

![accessing the login panel](https://cdn.ziomsec.com/skynet/4.webp)
...
![enumerating the SMB service](https://cdn.ziomsec.com/skynet/5.webp)
...
![connecting to the SMB share and inspecting it](https://cdn.ziomsec.com/skynet/6.webp)

I downloaded these files onto my local system.

![downloading the files locally](https://cdn.ziomsec.com/skynet/7.webp)

The *attention.txt* file confirmed the existence of a user called *milesdyson*. *log1.txt* contained a wordlist.

![viewing the downloaded files](https://cdn.ziomsec.com/skynet/8.webp)
...
![logging into the application](https://cdn.ziomsec.com/skynet/9.webp)

The email from *skynet* regarding SAMBA password reset seemed interesting so I opened it and found my SAMBA password.

![reading the email](https://cdn.ziomsec.com/skynet/10.webp)
...
![accesisng the user share](https://cdn.ziomsec.com/skynet/11.webp)

The *notes* directory contained a file called *important.txt* so I downloaded it.

![viewing the text file](https://cdn.ziomsec.com/skynet/12.webp)

The text file revealed a new endpoint.

![discovering a new endpoint](https://cdn.ziomsec.com/skynet/13.webp)

I accessed the endpoint but did not find anything useful at first.

![accessing the new endpoint](https://cdn.ziomsec.com/skynet/14.webp)
...
![fuzzing subdirectories in the new endpoint](https://cdn.ziomsec.com/skynet/15.webp)

I accessed it and found a *Cuppa* CMS login panel.

![accessing the cms login](https://cdn.ziomsec.com/skynet/16.webp)
...
![searching for exploits on exploit-db](https://cdn.ziomsec.com/skynet/17.webp)

I read the file and looked for the endpoint that was vulnerable.

![understanding the vulnerability](https://cdn.ziomsec.com/skynet/18.webp)

![looking for the required endpoint](https://cdn.ziomsec.com/skynet/19.webp)
...
![reading the /etc/passwd file](https://cdn.ziomsec.com/skynet/20.webp)
...
![reading credentials from config](https://cdn.ziomsec.com/skynet/21.webp)

![reading credentials from config](https://cdn.ziomsec.com/skynet/22.webp)
...
![gtting a reverse shell](https://cdn.ziomsec.com/skynet/23.webp)
...
![capturing the user flag](https://cdn.ziomsec.com/skynet/24.webp)
...
![viewing the backup directory](https://cdn.ziomsec.com/skynet/25.webp)
...
![reading the script](https://cdn.ziomsec.com/skynet/26.webp)
...
![listing crons](https://cdn.ziomsec.com/skynet/27.webp)
...
![exploiting the vulnerability](https://cdn.ziomsec.com/skynet/28.webp)
...
![capturing the root flag](https://cdn.ziomsec.com/skynet/29.webp)
