...
![performing an nmap scan on sickos-2 machine](https://cdn.ziomsec.com/sickos2/1.webp)

## Foothold

Since the target had port 80 open, I accessed it on the web and also viewed its source for anything interesting.

![accessing the web application](https://cdn.ziomsec.com/sickos2/2.webp)

```shell
curl http://TARGET
```

![viewing source code](https://cdn.ziomsec.com/sickos2/3.webp)
...
![fuzzing hidden directories on the target](https://cdn.ziomsec.com/sickos2/4.webp)

Fuzzing the application revealed a directory called *test* which had a directory listing.

![accessing directory list](https://cdn.ziomsec.com/sickos2/5.webp)
...
![running a nikto scan on the target application](https://cdn.ziomsec.com/sickos2/6.webp)
...
![investigating allowed methods on the target](https://cdn.ziomsec.com/sickos2/7.webp)
...
![uploading a php webshell](https://cdn.ziomsec.com/sickos2/8.webp)
...
![executing reverse shell payload](https://cdn.ziomsec.com/sickos2/9.webp)

```shell
rlwrap nc -lnvp 443
```

![getting a reverse shell](https://cdn.ziomsec.com/sickos2/10.webp)
...
![spawning a pty shell](https://cdn.ziomsec.com/sickos2/11.webp)
...
![starting an http server](https://cdn.ziomsec.com/sickos2/12.webp)
...
![downloading the linux smart enumeration script](https://cdn.ziomsec.com/sickos2/13.webp)

This script revealed that I had permissions to write in the paths present in cron jobs.

![executing linux smart enumeration script](https://cdn.ziomsec.com/sickos2/14.webp)
...
![investigating cron folder](https://cdn.ziomsec.com/sickos2/15.webp)
...
![searching for exploits](https://cdn.ziomsec.com/sickos2/16.webp)
...
![viewing the chkrootkit file](https://cdn.ziomsec.com/sickos2/17.webp)
...
![downloading the exploit](https://cdn.ziomsec.com/sickos2/18.webp)
![reading the exploitation steps](https://cdn.ziomsec.com/sickos2/19.webp)
...
![running the exploit](https://cdn.ziomsec.com/sickos2/20.webp)

> I used the update binary to modify the *sudoers* file so that my current user could run sudo commands without a password.

![running the exploit](https://cdn.ziomsec.com/sickos2/21.webp)

I then waited for a few minutes and switched the user to root.

![gaining root access](https://cdn.ziomsec.com/sickos2/22.webp)

Finally, I captured the flag from the root directory.

![capturing the root flag](https://cdn.ziomsec.com/sickos2/23.webp)
